...
#current condition time period WY 2002-2020, future mid-century and late-century
...
filename1 <- "C:/Users/KristineT/SCCWRP/Santa Margarita River Climate Change Analyses - FlowEcology/FlowData/FFM/Current_2002_2020/FFM_DeltaH_all_scenarios_mid_late_century.csv"
...
filename2 <- "C:/Users/KristineT/SCCWRP/Santa Margarita River Climate Change Analyses - FlowEcology/FlowData/FFM/Current_2002_2020/FFM_DeltaH_all_scenarios_CSCIASCI_alteration_mid_late_century.csv"
...
#add scenario type column, set all to Late-Century, change current to current, mid to mid-century
CSCI.sum.altered.only$ScenarioType <- "Late-Century"
CSCI.sum.altered.only$ScenarioType[ind.current] <- "Current"
#find mid-century and label
ind.midcentury <- grep("Mid-Century", CSCI.sum.altered.only$Scenario)
CSCI.sum.altered.only$ScenarioType[ind.midcentury] <- "Mid-Century"
...
#write.csv
write.csv(pivot.CSCI, file="C:/Users/KristineT/SCCWRP/Santa Margarita River Climate Change Analyses - FlowEcology/FlowData/FFM/Current_2002_2020/CSCI_alteration_summary_scenarios_mid_late_century.csv", row.names=FALSE)
...
#add scenario type column, set all to Late-Century, change current to current, mid to mid-century
ASCI.sum.altered.only$ScenarioType <- "Late-Century"
ASCI.sum.altered.only$ScenarioType[ind.current] <- "Current"
#find mid-century
ind.midcentury <- grep("Mid-Century", ASCI.sum.altered.only$Scenario)
ASCI.sum.altered.only$ScenarioType[ind.midcentury] <- "Mid-Century"
...
#write.csv
write.csv(pivot.ASCI, file="C:/Users/KristineT/SCCWRP/Santa Margarita River Climate Change Analyses - FlowEcology/FlowData/FFM/Current_2002_2020/ASCI_alteration_summary_scenarios_mid_late_century.csv", row.names=FALSE)
